...
export const FEATURES = [
  // ------------------------------------------------------------------ NUCLEO
  {
    ...
    keys: [
      ...
      { es: 'Super+1..9 (ir a la pestaña N)', en: 'Super+1..9 (jump to tab N)' },
  ...
  },
  {
    ...
    keys: [
      ...
      { es: 'Super+flechas (redimensionar)', en: 'Super+arrows (resize)' },
    ],
  ...
  // ------------------------------------------------------- ENTRADA Y SELECCION
  {
    ...
    natural: {
      es: 'Casi todo tiene atajo; lo que no, vive en la paleta. Los atajos propios usan Ctrl+Shift o Super, nunca Ctrl+letra a secas, que pertenece al programa del panel (Ctrl+C, Ctrl+D). runnir no pisa lo que espera tu shell.',
      en: 'Almost everything has a bind; the rest lives in the palette. runnir’s binds use Ctrl+Shift or Super, never a bare Ctrl+letter — that belongs to the program in the pane (Ctrl+C, Ctrl+D). runnir never steps on what your shell expects.',
    },
    keys: [
  ...
  },
  {
    ...
    natural: {
      es: 'Reasigna cualquier acción a la combinación que prefieras desde el config; tus atajos se fusionan sobre los de fábrica. Los acordes se escriben "ctrl+shift+t", "alt+enter", "super+1". Regla de oro: los atajos propios llevan Ctrl+Shift o Super, nunca Ctrl+letra a secas.',
      en: 'Rebind any action to the combo you like from the config; your binds merge over the defaults. Chords are written "ctrl+shift+t", "alt+enter", "super+1". Rule of thumb: your own binds use Ctrl+Shift or Super, never a bare Ctrl+letter.',
    },
