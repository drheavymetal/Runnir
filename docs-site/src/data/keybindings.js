...
export const KEY_GROUPS = [
  {
    ...
    rows: [
      { keys: ['Alt+Shift+Space'], id: 'leader', title: { es: 'Armar la capa leader; luego una tecla suelta. Mientras está armada sale LEADER en la barra inferior; caduca a los 3 s. Se reasigna con el ajuste leader; "" la desactiva', en: 'Arm the leader layer, then one plain key. While armed the bottom bar shows LEADER; it expires after 3 s. Rebind with the leader setting; "" turns it off' } },
