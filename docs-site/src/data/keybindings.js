...
export const KEY_GROUPS = [
  {
    ...
    rows: [
      ...
      { keys: ['Leader Z / Shift+Z / 0'], id: 'font_*', title: { es: 'Tamaño de fuente: aumentar / reducir / reset. También + y −, en las distribuciones donde son una sola tecla (en la española no lo son todas)', en: 'Font size: bigger / smaller / reset. Also + and −, on layouts where those are a single key (on the Spanish one they are not)' } },
