// Vendored VERBATIM from decimen-optical-transfer (MIT):
// https://github.com/bashalarmistalt/decimen-optical-transfer
//
// Do not edit. This file is the wire format the runnir sender was ported from
// (see src/optical.rs), and the two ends derive every frame's block subset
// independently and never compare notes — an edit here that looks harmless
// desynchronises the receiver from every sender in the world, silently. Update
// it by re-vendoring upstream and re-running the Rust golden vectors.
//
// See LICENSE-decimen in this directory.
